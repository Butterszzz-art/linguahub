...
//
// Populates a "Turkish" classroom from manifest-turkish.json + the generated
// HTML lesson files under content/turkish/ (see
// scripts/generate-turkish-content.ts, which produces both from the
// plain-text curriculum in content-source/turkish/).
//
// Run with: npx tsx prisma/seed-turkish.ts
