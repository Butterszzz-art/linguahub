// prisma/seed-german.ts
//
// Populates a "German" classroom from manifest-german.json + the generated
// HTML lesson files under content/german/ (see
// scripts/generate-german-content.ts, which produces both from the
// plain-text curriculum in content-source/german/).
//
// Run with: npx tsx prisma/seed-german.ts
